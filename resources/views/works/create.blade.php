                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('works.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="faq" name="faq" rows="4" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">{{ old('faq') }}</textarea>
