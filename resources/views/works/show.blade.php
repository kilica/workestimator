        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                ...
                <div class="p-6">
                    ...
                    <div class="mb-6">
                        <h2 class="text-lg font-semibold mb-2">{{ __('課題・背景') }}</h2>
                                ...
                                @if($evaluation->is_visible || Auth::user() && (Auth::user()->isAdmin() || Auth::user()->isStaff()))
                                    <div class="border rounded-lg p-4 {{ !$evaluation->is_visible ? 'bg-red-50' : '' }}">
                                        ...
                                        <div class="mt-3 flex justify-between items-center">
                                            ...
                                            @if(Auth::user() && Auth::id() == $evaluation->user_id)
                                                <a href="https://twitter.com/intent/tweet?text={{ urlencode('山田太郎議員の実績「' . $work->title . '」: '. mb_substr($evaluation->comment, 0, 80) .' ' . $work->improvements) }}&url={{ urlencode(route('works.show', $work->id)) }}" target="_blank" class="text-sm text-blue-500 hover:text-blue-700">
