                    ...
                    <div class="mb-12">
                        ...
                        <div class="space-y-6">
                            ...
                            <div id="china" class="bg-gray-50 p-4 rounded-lg relative">
                                ...
                                <p>また、山田太郎議員は台湾視察の際に台湾の高官とも面会していますが、その際、台湾政府から徹底的なチェックを受けています。そのうえで面会が実現していますので、そのへんの評論家やYouTuberの発言よりはよほど信頼できるでしょう。</p>
                            </div>
                            ...
                            <div id="china" class="bg-gray-50 p-4 rounded-lg relative">
                                ...
                                <p>しかも、この講演では「表現の自由」について話しており、本当にこれが統一教会のイベントだとすると表現規制を推し進めたい統一教会に喧嘩を売るような内容と言えます。</p>
                                <p>さらに山田議員は親の信仰に基づく宗教虐待の問題に精力的に取り組んできた議員の一人です。宗教団体によるこどもへの強制的な信仰・献金などの問題解決に注力しており、統一教会の活動に真っ向から立ち向かっている議員です。</p>
                            </div>
                    ...
                    <div class="mb-12">
                        ...
                        <div class="space-y-6">
                            ...
                            <div id="vote-to-other-expression-member" class="bg-gray-50 p-4 rounded-lg relative">
                                ...
                                <p>また、一度法律で規制されたものについて、その規制を外すのは、規制がかかる前に防ぐよりも何倍も困難です。それどころか「規制は拡大していくもの」と考えたほうがいいでしょう。</p>
                                <p>「こういう問題が起きたからこれだけは規制しよう」で始まった規制も、「こんな問題も起きたからこれも同じように規制しよう」がどんどん増えていくものです。</p>
